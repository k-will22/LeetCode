<h2>824. Goat Latin</h2><h3>Easy</h3><hr><div><p>A sentence <code>sentence</code> is given, composed of words separated by spaces. Each word consists of lowercase and uppercase letters only.</p>
